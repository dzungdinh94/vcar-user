...
class EnterRegisterPhoneView extends Component {
  ...
  confirmPhone = () => {
    this.props.confirmPhone(this.state.phone)
  }
    ...
    return (
      <TouchableOpacity activeOpacity={1}
        ...
        <View style={{ width: '100%', backgroundColor: '#E7E7E7', borderRadius: 12, }}>
          ...
          }}>{'Vui lòng bổ sung số điện thoại của bạn'}</Text>
          ...
          <View style={{ width: '100%', flexDirection: 'row', backgroundColor: 'transparent', borderTopColor: color.borderColor_gray, borderTopWidth: 0.5 }}>
            ...
            <TouchableOpacity onPress={this.confirmPhone} activeOpacity={0.7} style={{ flex: 1, paddingVertical: 12, alignItems: 'center', justifyContent: 'center', }}>
